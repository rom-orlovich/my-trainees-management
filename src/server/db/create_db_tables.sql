...
CREATE TABLE
  IF NOT EXISTS "measures" (
    ...
    CONSTRAINT fk_profile_id FOREIGN KEY (profile_id) REFERENCES profiles (profile_id) ON DELETE SET NULL ON UPDATE CASCADE
  );
...
CREATE TABLE
  IF NOT EXISTS "users" (
    ...
    "refresh_tokens" TEXT ARRAY DEFAULT '{}',
    "verify_token" TEXT,
    "profile_id" INTEGER,
...
ALTER TABLE "cities" add CONSTRAINT fk_user_id FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "profiles" add CONSTRAINT fk_location_id FOREIGN KEY (location_id) REFERENCES locations (location_id) ON DELETE SET NULL ON UPDATE CASCADE;
...
CREATE TABLE
  IF NOT EXISTS "leads" (
    ...
    "user_id" INTEGER DEFAULT 1,
    CONSTRAINT "gender" CHECK ("gender" IN ('male', 'female', 'other')),
    CONSTRAINT fk_location_id FOREIGN KEY (location_id) REFERENCES locations (location_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_user_id FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE SET NULL ON UPDATE CASCADE
  );
...
CREATE TABLE
  IF NOT EXISTS "exercises_list" (
    "exercise_id" serial PRIMARY KEY,
    "exercise_name" VARCHAR(50) NOT NULL,
    "muscles_group_id" INTEGER NOT NULL,
    "equipment_id" INTEGER,
    "user_id" INTEGER DEFAULT 1,
    CONSTRAINT fk_muscles_group_id FOREIGN KEY (muscles_group_id) REFERENCES muscles_group (muscles_group_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_equipment_id FOREIGN KEY (equipment_id) REFERENCES equipments (equipment_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_user_id FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE SET NULL ON UPDATE CASCADE
  );
...
CREATE TABLE
  IF NOT EXISTS "trainees" (
    ...
    "profile_id" INTEGER,
    "sign_up_token" TEXT,
    CONSTRAINT fk_trainer_user_id FOREIGN KEY (trainer_user_id) REFERENCES users (user_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_user_id FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_profile_id FOREIGN KEY (profile_id) REFERENCES profiles (profile_id) ON DELETE CASCADE ON UPDATE CASCADE
  );

CREATE TABLE
  IF NOT EXISTS "training_programs_list" (
...
CREATE TABLE
  IF NOT EXISTS "training_program" (
    ...
    CONSTRAINT fk_training_programs_list_id FOREIGN KEY (training_programs_list_id) REFERENCES training_programs_list (training_programs_list_id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE
  IF NOT EXISTS "training_program_exercises_stats" (
...
CREATE TABLE
  IF NOT EXISTS "products" (
    ...
    "price" FLOAT,
    "user_id" INTEGER DEFAULT 1,
    CONSTRAINT "product_type" CHECK ("product_type" IN ('Subscription Plan', 'Nutrition Plan', 'Expense', 'Other')),
    CONSTRAINT fk_user_id FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE SET NULL ON UPDATE CASCADE
  );
...
CREATE TABLE
  IF NOT EXISTS "incomes" (
    ...
    "user_id" INTEGER DEFAULT 1,
    CONSTRAINT fk_product_id FOREIGN KEY (product_id) REFERENCES products (product_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_trainee_id FOREIGN KEY (buyer_id) REFERENCES trainees (trainee_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_user_id FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE SET NULL ON UPDATE CASCADE
  );
...
CREATE TABLE
  IF NOT EXISTS "participants_groups_list" (
...
CREATE TABLE
  IF NOT EXISTS "participants_group" (
    "participants_group_id" serial PRIMARY KEY,
    "participants_groups_list_id" INTEGER,
    "trainee_id" INTEGER NOT NULL,
    "user_id" INTEGER DEFAULT 1,
    CONSTRAINT fk_participants_groups_list_id FOREIGN KEY (participants_groups_list_id) REFERENCES participants_groups_list (participants_groups_list_id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_trainee_id FOREIGN KEY (trainee_id) REFERENCES trainees (trainee_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_user_id FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE CASCADE ON UPDATE CASCADE
  );
...
CREATE TABLE
  IF NOT EXISTS "meetings" (
    ...
    "user_id" INTEGER DEFAULT 1,
    CONSTRAINT "date_end" check (date_end > date_start),
    CONSTRAINT fk_activity_id FOREIGN KEY (activity_id) REFERENCES activities (activity_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_location_id FOREIGN KEY (location_id) REFERENCES locations (location_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_participants_groups_list_id FOREIGN KEY (participants_groups_list_id) REFERENCES participants_groups_list (participants_groups_list_id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_user_id FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE SET NULL ON UPDATE CASCADE
  );
